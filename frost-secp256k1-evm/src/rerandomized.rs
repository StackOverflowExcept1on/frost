...
pub fn sign_with_randomizer_seed(
    ...
    frost_rerandomized::sign_with_randomizer_seed::<crate::Secp256K1Keccak256>(
        signing_package,
        signer_nonces,
        key_package,
        randomizer_seed,
...
pub fn aggregate(
    ...
    frost_rerandomized::aggregate::<crate::Secp256K1Keccak256>(
        signing_package,
        signature_shares,
        pubkeys,
        randomized_params,
...
pub fn aggregate_custom(
    ...
    frost_rerandomized::aggregate_custom::<crate::Secp256K1Keccak256>(
        signing_package,
        signature_shares,
        pubkeys,
        cheater_detection,
...
pub type Randomizer = frost_rerandomized::Randomizer<crate::Secp256K1Keccak256>;

/// Randomized parameters for a signing instance of randomized FROST.
pub type RandomizedParams = frost_rerandomized::RandomizedParams<crate::Secp256K1Keccak256>;
