...
21. Check if other crates are ready to be published: `for cs in ristretto255 ed25519 secp256k1 secp256k1-evm p256 ed448; do cargo publish -p frost-$cs --dry-run; done`. Fix any issues if needed.
...
23. Publish those crates: `for cs in ristretto255 ed25519 secp256k1 secp256k1-evm p256 ed448; do cargo publish -p frost-$cs; done`
